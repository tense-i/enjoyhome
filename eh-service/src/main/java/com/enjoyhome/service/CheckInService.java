...
public interface CheckInService extends IActFlowCustomService {
     ...
     * @return
     */
    ResponseResult selectByPage(String checkInCode, String name, String idCardNo, LocalDateTime start,
                                LocalDateTime end, Integer pageNum, Integer pageSize, String deptNo, Long userId);
